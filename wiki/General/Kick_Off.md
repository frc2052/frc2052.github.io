...
| Time | Task |
| :---- | :---- |
| 10:00 | Leadership arrives Setup rooms for KickOff Setup food for lunch |
| 10:45 | Students Arrive |
| 11:00 | Watch Kickoff stream.  Each lunch during broadcast |
| 12:00 | Students divide into two groups. Red/Blue Each group further divides into 3 sub-groups and are assigned pages in rules manual |
| 12:15 | Red/Blue separate to different rooms.  Read Manual Sections |
| 12:45 | Red/Blue present finding from manual, still in separate rooms |
| 1:30 | Red/Blue discuss “how to play” strategy (not mechanisms) in 6 subgroups Mentors & Captains define 4-6 archetype robots Mentors & Alumni tape off full size field in gym/cafeteria using official CAD |
| 2:00 | Mentors & Captains deliver robot archetypes to students Students discuss how to use the archetypes to form a 3 robot alliance and plan for 3-4 human robot simulation matches Mentors define 2-5 autonomous routines 1 Mentor creates score card to track robot simulation scoring |
| 2:30 | Robot simulation and post simulation analysis |
| 3:30 | Most students dismissed after cleaning up Design Team defines first sets of prototypes to design build, set priorities for prototyping |
| 4:45 | Kicked out of school \- evaluate if additional off-site or online meeting needed |
